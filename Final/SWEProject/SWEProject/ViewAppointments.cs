...
namespace SWEProject
{
    ...
    {
        //bya5od  string conn w string select statement w bynfzha fl database
        ...
        {  //con
            ...
            //select statemnt..merge l table el dr wl appt
            ...
            Ds = new DataSet();
            //7nmla bl rows el tl3tlna mn el select statemnt
            adapter.Fill(Ds);
            for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
            {
                comboBox1.Items.Add(Ds.Tables[0].Rows[i][0]);
            }
            //view el info of the patient
