...
namespace SWEProject
{
    ...
    {   //initializing lel string bta3 el patid 3shan nsta3mlo 5lal el form
        public static int pat_id=-1;
        //3mlna el oracle coonection
        ...
        private void createacc_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //3mlna reading w et2kdt en el account doesnit exist 
                dr.Close();
